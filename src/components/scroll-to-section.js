...
// import { useScroll, useMotionValueEvent } from "framer-motion"; // Ensure these are imported
...
//       {isOpen && (
//         <motion.div
//           className="fixed inset-0 bg-gray-900/95 backdrop-blur-lg z-40 pt-10 px-6 md:hidden"
